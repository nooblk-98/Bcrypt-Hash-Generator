/**
 * Header.js — Sticky site navigation header with logo and nav links.
 */
    ...
    <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-gray-100 shadow-sm">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <Link
          ...
          aria-label="BcryptGenerator — Go to homepage"
        >
          <div
            className="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-500 to-blue-700
          ...
          <span className="font-bold text-gray-800 text-base leading-tight hidden sm:block">
            Bcrypt<span className="text-blue-600">Generator</span>
            <span className="block text-xs font-normal text-gray-400 leading-none">
              Online Hash Tool
            </span>
          </span>
        </Link>
                ...
                >
                  <path
                    ...
                    d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483
                       ...
                       1.026A9.564 9.564 0 0 1 12 6.844a9.59 9.59 0 0 1 2.504.337c1.909-1.296 2.747-1.027
                       ...
                       .268.18.58.688.482A10.02 10.02 0 0 0 22 12.017C22 6.484 17.522 2 12 2z"
                    clipRule="evenodd"
                  />
                </svg>
